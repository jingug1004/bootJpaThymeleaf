...
import org.zerock.guestbook.shop.dto.CartDetailDto;
import org.zerock.guestbook.shop.dto.CartItemDto;
import org.zerock.guestbook.shop.dto.CartOrderDto;
import org.zerock.guestbook.shop.dto.OrderDto;
import org.zerock.guestbook.shop.entity.Cart;
import org.zerock.guestbook.shop.entity.CartItem;
...
public class CartService {
    ...
    public boolean validateCartItem(Long cartItemId, String email) {
        Mem curMember = memberRepository.findByEmail(email);
        CartItem cartItem = cartItemRepository.findById(cartItemId)
                .orElseThrow(EntityNotFoundException::new);
        Mem savedMember = cartItem.getCart().getMember();
